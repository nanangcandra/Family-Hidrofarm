                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="<?php echo base_url() . "index.php/hal_admin/hapus_data/" . $dat['Nomor']; ?>"> <i class="fas fa-trash-alt"></i></a>
                                                <a class="btn btn-primary" href="<?php echo base_url() . "index.php/hal_admin/ambil_dataWhere/" . $dat['Nomor']; ?>"><i class="fas fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
